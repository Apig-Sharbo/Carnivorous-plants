...
<title>Database Control</title>
	<style>
		...
		body
		{
			...
			/*background: rgba(70, 72, 82, 0.3);*/      /*try to darken bg image by finding out what code to use*/
			background-image: url(images/dark_img1.jpg);     
		...
		.db_buttons
		{
			...
			border-width:2px;
			border-style:solid;               /*this fixes the bordercolorlight bordercolordark problem */
...
<body>
  ...
  if($sub_search=="Search") 
	...
	?>
	<a href="CoursePr.php"><div class="backbtn">&#x21E6 Go Back</div></a>
	<br>
	<br>
	...
	<form action="" method="POST">
		<table>
			...
			<tr>
				<td>Plant name</td>
				<td><input type="text" style="width: 160px; font-family: sans-serif;" maxlength="20" name="plant_name_input" 	  /></td>
				<td><span class="error"><?php echo $plantnameErr;?></span></td>
			</tr>
			
			<tr>
				<td>Scientific name</td>
				<td><input type="text" style="font-style: italic; width: 160px; font-family: serif;" maxlength="20" name="scientific_name_input" /></td>
